...
history = model.fit(train_images, train_labels, epochs=30, batch_size=64, validation_split=0.1, callbacks=[test_accuracy_callback])
...
while true_labels[k] != 5:
    k = k + 1
    
test_image = test_images[k:k+1]  # Use one image, reshape to match the input shape    
